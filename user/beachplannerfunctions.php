...
if (isset($_POST['func']) && !empty($_POST['func'])) {
    switch ($_POST['func']) {
        ...
        //For Add Event
        case 'addEvent':
            addEvent($_POST['date'], $_POST['title'],$_POST['user_id'], $_POST['fname'], $_POST['address'], $_POST['contact'], $_POST['email'], $_POST['location'], $_POST['vlocation'], $_POST['hour'], $_POST['minutes'], $_POST['deal'], $_POST['guests'], $_POST['chairs'], $_POST['tables'], $_POST['style'], $_POST['types'], $_POST['instruction'],$_POST['confirmation']);
            break;
        default:
            break;
    }
            ...
            <ul>
                ...
                for ($cb = 1; $cb <= $boxDisplay; $cb++) {
                    if (($cb >= $currentMonthFirstDay + 1 || $currentMonthFirstDay == 7) && $cb <= ($totalDaysOfMonthDisplay)) {
                        ...
                        $result = $db->query("SELECT title FROM weddingplusbookings WHERE date = '" . $currentDate . "' AND status = 1");
...
function getEvents($date = '') {
    ...
    $result = $db->query("SELECT title FROM weddingplusbookings WHERE date = '" . $date . "' AND status = 1");
