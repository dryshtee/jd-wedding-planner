<?php include_once('photosfunctions.php'); ?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	<title>Photos and Videos Booking </title>
 ...
 <body onload = "javascript:Unvisible();">
        ...
        <!--body-->
		<a href ="photography1.php"><img src="images/back.png" > Back to Girish Balgobin Photography</a>
