        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                $query = mysql_query("SELECT * FROM cakemaker WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_cakemaker.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm10.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel10.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
