        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
					<?php
                $query = mysql_query("SELECT * FROM venue4bookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_mondesir.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm8.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel8.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Chateau Mon Desir</h4>
                        </div>
