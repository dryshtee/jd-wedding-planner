...
while ($row = mysql_fetch_array($rs_result)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query7 = mysql_query("update suppliers set username='$username', password='$password', supplier_name='$supplier_name', supplier_link='$supplier_link', price='$price', price2='$price2', price3='$price3', price4='$price4', price5='$price5', description='$description' where supplier_id='$session_id'");
        if ($query7) {
    ...
    <form method="POST" action="<?php $_PHP_SELF ?>">
        ...
        <div class="form-group">
            <label for="price">Wedding Bands</label>
        ...
        <div class="form-group">
            <label for="price2">Magicians</label>
        ...
        <div class="form-group">
            <label for="price4">Dancers</label>
        ...
        <div class="form-group">
            <label for="price5">Comedy Acts</label>
            <input type="text" class="form-control" name="price5" id="price5" value="<?php echo $row['price5']; ?>" pattern=".{3,}" title="Input your price (must contain numbers only)" required/>
        </div>
