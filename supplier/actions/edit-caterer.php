...
while ($row = mysql_fetch_array($rs_result)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query7 = mysql_query("update suppliers set username='$username', password='$password', supplier_name='$supplier_name', supplier_link='$supplier_link', price='$price', price2='$price2', price3='$price3', description='$description' where supplier_id='$session_id'");
        if ($query7) {
    ...
    <form method="POST" action="<?php $_PHP_SELF ?>">
        ...
        <div class="form-group">
            <label for="price">Buffet Menu 1</label>
        ...
        <div class="form-group">
            <label for="price2">Buffet Menu 2</label>
        ...
        <div class="form-group">
            <label for="price3">Buffet Menu 3</label>
