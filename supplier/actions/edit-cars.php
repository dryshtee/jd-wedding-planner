...
while ($row = mysql_fetch_array($rs_result)) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query7 = mysql_query("update suppliers set username='$username', password='$password', supplier_name='$supplier_name', supplier_link='$supplier_link', price='$price', price2='$price2', price3='$price3', price4='$price4', price5='$price5', price6='$price6', description='$description' where supplier_id='$session_id'");
        if ($query7) {
    ...
    <form method="POST" action="<?php $_PHP_SELF ?>">
        ...
        <div class="form-group">
            <label for="price3">Mini Cooper Cabriolet</label>
            <input type="text" class="form-control" name="price3" id="price3" value="<?php echo $row['price3']; ?>" pattern=".{3,}" title="Input your price (must contain numbers only)" required/>
                ...
                <div class="form-group">
            <label for="price4">Stone White Limousine</label>
            <input type="text" class="form-control" name="price4" id="price" value="<?php echo $row['price4']; ?>" pattern=".{3,}" title="Input your price (must contain numbers only)" required/>
        </div>
        <div class="form-group">
            <label for="price5">44 Seaters Bus</label>
            <input type="text" class="form-control" name="price5" id="price2" value="<?php echo $row['price5']; ?>" pattern=".{3,}" title="Input your price (must contain numbers only)" required/>
        </div>
        <div class="form-group">
            <label for="price6">13 Seaters Van</label>
            <input type="text" class="form-control" name="price6" id="price3" value="<?php echo $row['price6']; ?>" pattern=".{3,}" title="Input your price (must contain numbers only)" required/>
        </div>
        
        <label>Input values to calculate price</label><br/>
        <input type="text" name="input1" id="input1" onkeyup="calc()" value="" placeholder="value 1"><br/><br/>
        X
        <input type="text" name="input2" id="input2" onkeyup="calc()" value="" placeholder="value 2"><br/><br/>
        =
