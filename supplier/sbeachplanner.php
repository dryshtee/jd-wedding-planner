        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
					<?php
                $query = mysql_query("SELECT * FROM weddingplusbookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_beachplanner.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm2.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel2.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
				</tbody>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">WeddingPlus Wedding Planner</h4>
                        </div>
                        <div class="modal-body">
                            <?php
                            include 'actions/edit-planner.php';
                            ?>
                        </div>
                    </div>
                </div>
            ...
            <center>
                <div class="container">
                    ...
                    <div class="jumbotron">
                        <table class="table table-striped">
                            <td>Name: </td>
                            <td> <input type="text" name="fullname" value="<?php echo $row['supplier_name']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Username: </td>
