        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
                       <?php
                $query = mysql_query("SELECT * FROM kvsbookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_rusticplanner.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm3.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel3.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
