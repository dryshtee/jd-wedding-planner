        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                $query = mysql_query("SELECT * FROM musicbookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_music.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm11.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel11.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php
                            include 'actions/edit-music.php';
                            ?>
                        </div>
                    </div>
                </div>
