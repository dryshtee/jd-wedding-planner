        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
					<?php
                $query = mysql_query("SELECT * FROM aubineauxbookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_aubineaux.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm5.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel5.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Domaine des Aubineaux</h4>
                        </div>
                        <div class="modal-body">
                            <?php
                            include 'actions/edit-venue.php';
                            ?>
                        </div>
                    </div>
                </div>
