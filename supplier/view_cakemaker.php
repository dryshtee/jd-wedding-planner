...
<html>
    ...
    <body>
        ...
        <div class="wedding-section">
            <div class="container">
                <?php
                $query = mysql_query("SELECT * FROM cakemaker WHERE id='$id'")or die(mysql_error());
                    ...
                    <div class="jumbotron">
                        <table>
                            <tbody>
                                ...
                                <label>Choice:</label> <?php echo $row['choice']; ?><br/>
                                <label>Tier(s):</label> <?php echo $row['tier']; ?><br/>
                                <label>Flavour:</label> <?php echo $row['flavor']; ?><br/>
                            ...
                            <div id="openModal2" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										<p>
											<?php
                                            include 'actions/delete_cakemaker.php';
                                            ?>
											</p>
                                        </div>
                                    </div>
