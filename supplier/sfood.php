        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
					<?php
                $query = mysql_query("SELECT * FROM catererbookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_food.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm9.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel9.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php
                            include 'actions/edit-caterer.php';
                            ?>
                        </div>
                    </div>
                </div>
