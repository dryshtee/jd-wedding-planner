        ...
        <div id="bookingDetails" class="container-fluid">
            ...
            <div class="container">            
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                $query = mysql_query("SELECT * FROM floralbookings WHERE supplier_id='$session_id'") or die(mysql_error());
                while ($row = mysql_fetch_array($query)) {
                    ...
                    echo"<td><a href ='view_floralplanner.php?id=$id'>View</a>&nbsp;&nbsp;&nbsp;<a href ='confirm4.php?id=$id'>Confirm</a>&nbsp;&nbsp;&nbsp;<a href ='cancel4.php?id=$id'>Cancel</a>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
