...
<html>
    ...
    <body>
        ...
        <div class="wedding-section">
            <div class="container">
                <?php
                $query = mysql_query("SELECT * FROM weddingplusbookings WHERE id='$id'")or die(mysql_error());
                        ...
                        <table>
                            <tbody>
                                <label>Date created:</label> <?php echo $row['created']; ?><br/>
                                        ...
                                        <label>Ceremony Location:</label> <?php echo $row['location']; ?><br/>
                            ...
                            <div id="openModal2" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										<p>
											<?php
                                            include 'actions/delete_beachplanner.php';
                                            ?>
											</p>
                                        </div>
                                    </div>
