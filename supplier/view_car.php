...
<html>
    ...
    <body>
        ...
        <div class="wedding-section">
            <div class="container">
                <?php
                $query = mysql_query("SELECT * FROM carsbookings WHERE id='$id'")or die(mysql_error());
                ...
                <center>
                    <div class="jumbotron">
                        <table>
							...
							<label>Pickup Address:</label> <?php echo $row['paddress']; ?><br/>
							<label>Time:</label> <?php echo $row['hour']; ?>:<?php echo $row['minutes']; ?><br/>
							<label>Duration:</label> <?php echo $row['duration']; ?><br/>
							<label>For couples:</label> <?php echo $row['transport']; ?><br/>
							<label>For guests:</label> <?php echo $row['transport1']; ?><br/>
							<label>Additional Info:</label> <?php echo $row['info']; ?><br/>
                            <td>
                            ...
                            <div id="openModal2" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										<p>
											<?php
                                            include 'actions/delete_car.php';
                                            ?>
											</p>
                                        </div>
                                    </div>
