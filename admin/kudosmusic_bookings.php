...
<!DOCTYPE html>
<html>
<title> Kudos Music and Entertainment Bookings </title>
<head>
...
<div class="container">
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="reg_membersTable">
	<th> Booking ID </th>
	<th> Music and Entertainment </th>
	<th> Fullname </th>
	<th> Wedding Date </th>
	<th> Ceremony Time </th>
	<th> Ceremony Address </th>
	<th> Entertainment Selected</th>
	<th> Duration</th>
...
$query = mysql_query("SELECT * FROM musicbookings") or die(mysql_error());
while($row = mysql_fetch_array($query))
{
	...
	echo"<td>". $row['music']. ":". $row['music1']. ":". $row['music2']. ":". $row['music3']. ":". $row['music4']. "</td>";
	echo"<td>". $row['info']. "</td>";
