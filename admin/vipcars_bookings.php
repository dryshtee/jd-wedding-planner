...
<!DOCTYPE html>
<html>
<title> VIP Wedding Cars Bookings </title>
<head>
...
$query = mysql_query("SELECT * FROM carsbookings") or die(mysql_error());
while($row = mysql_fetch_array($query))
{
	...
	echo"<td>". $row['transport']. "&nbsp;". $row['transport1']. "</td>";
	echo"<td>". $row['info']. "</td>";
