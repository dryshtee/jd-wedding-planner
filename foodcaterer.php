							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li class="active"><a href="foodcaterer.php">Food Caterer</a></li>
                ...
                <div class="container">
                    ...
                    <div class="services-grids">
                        <div class="col-md-4 services-grid">
                            <div class="ser1">
                                <a href="login.php"><img src="images/f1.jpg" class="img-responsive" alt="" /></a>
                                <h4>Taste Mauritius Private Catering</h4>
                                <p></p>
                            </div>
                        </div>
